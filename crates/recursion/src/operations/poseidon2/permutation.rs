...
const fn make_col_map_degree3() -> Poseidon2Degree3Cols<usize> {
    ...
    // SAFETY: Poseidon2Degree3Cols<usize> is repr-transparent over an array of usize fields,
    // with size == NUM_POSEIDON2_DEGREE3_COLS. Transmuting from a sequential index array is valid.
    unsafe {
...
const fn make_col_map_degree9() -> Poseidon2Degree9Cols<usize> {
    ...
    // SAFETY: Same rationale as make_col_map_degree3; layout matches [usize; N].
    unsafe {
