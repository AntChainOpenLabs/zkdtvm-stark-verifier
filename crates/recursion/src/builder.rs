...
/// A trait which contains all helper methods for building zkDTVM recursion machine AIRs.
pub trait DTRecursionAirBuilder: MachineAirBuilder + RecursionAirBuilder {}

impl<AB: AirBuilderWithPublicValues + RecursionAirBuilder> DTRecursionAirBuilder for AB {}
