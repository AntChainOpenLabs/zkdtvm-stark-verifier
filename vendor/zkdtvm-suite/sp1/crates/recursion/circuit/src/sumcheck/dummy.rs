use dt_stark::{sumcheck::types::UniPolyEvals, InnerChallenge};
use p3_field::AbstractField;

pub fn dummy_unipoly(degree: usize) -> UniPolyEvals<InnerChallenge> {
    UniPolyEvals { evals: vec![InnerChallenge::zero(); degree + 1] }
}
