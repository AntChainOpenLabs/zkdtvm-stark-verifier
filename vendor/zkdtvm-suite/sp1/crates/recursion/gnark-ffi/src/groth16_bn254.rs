...
use crate::{
    ...
    Groth16Bn254Proof, DT_CIRCUIT_VERSION,
};
...
impl Groth16Bn254Prover {
    ...
    pub fn build_contracts(build_dir: PathBuf) {
        ...
        let dt_verifier_path = build_dir.join("DTVerifierGroth16.sol");
        let vkey_hash = Self::get_vkey_hash(&build_dir);
        let dt_verifier_str = include_str!("../assets/DTVerifierGroth16.txt")
