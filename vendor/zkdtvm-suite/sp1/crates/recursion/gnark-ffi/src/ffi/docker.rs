use crate::{Groth16Bn254Proof, PlonkBn254Proof, ProofBn254, DT_CIRCUIT_VERSION};
...
fn get_docker_image() -> String {
    std::env::var("DT_GNARK_IMAGE")
        .unwrap_or_else(|_| format!("ghcr.io/succinctlabs/sp1-gnark:{DT_CIRCUIT_VERSION}"))
}
