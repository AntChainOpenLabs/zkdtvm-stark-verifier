...
namespace dt_recursion_core_sys::public_values {
template <class F>
__DT_HOSTDEV__ void event_to_row(const CommitPublicValuesEvent<F>& event,
                                  size_t digest_idx,
...
template <class F>
__DT_HOSTDEV__ void instr_to_row(const CommitPublicValuesInstr<F>& instr,
                                  size_t digest_idx,
