...
use crate::{
    air::Block, builder::DTRecursionAirBuilder, runtime::ExecutionRecord, Instruction,
    SumcheckRoundInstr,
};
        ...
        input.sumcheck_round_events.iter().for_each(|event| {
            ...
            rows.iter_mut().enumerate().for_each(|(i, row)| {
                ...
                if i == 0 {
                    ...
                    running_sum = (ChallengeExtension(prev_running_sum.0) +
                        ChallengeExtension(cols.current_coeff.0))
                    .0
                    .into();
                    horner_accum = (ChallengeExtension(prev_horner_mul_challenge.0) +
                        ChallengeExtension(cols.current_coeff.0))
                    .0
                    .into();
                }
                ...
                cols.horner_accum_mul_challenge = (ChallengeExtension(horner_accum.0) *
                    ChallengeExtension(cols.challenge.0))
                .0
                .into();
