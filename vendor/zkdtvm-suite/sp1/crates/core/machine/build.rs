...
mod sys {
    ...
    const LIB_NAME: &str = "dt-core-machine-sys";
    ...
    pub fn build_ffi() {
        ...
        match cbindgen::Builder::new()
            ...
            .include_item("AluEventFfi") // FFI-safe version of AluEvent for C++ interop.
            .include_item("SyscallEventFfi") // FFI-safe version of SyscallEvent for C++ interop.
            .include_item("SyscallCode") // Required for populating the CPU columns for ECALL.
            // Exclude types that contain Option<MemoryRecordEnum> or MemoryRecordEnum
            // which cbindgen cannot generate valid C++ for.
            .exclude_item("CpuEvent")
            .exclude_item("AluEvent")
            .exclude_item("MemInstrEvent")
            .exclude_item("BranchEvent")
            .exclude_item("JumpEvent")
            .exclude_item("AUIPCEvent")
            .exclude_item("SyscallEvent")
            .exclude_item("MemoryRecordEnum")
            ...
            .with_namespace("dt_core_machine_sys")
        ...
        // Propagate field selection to C++ code.
