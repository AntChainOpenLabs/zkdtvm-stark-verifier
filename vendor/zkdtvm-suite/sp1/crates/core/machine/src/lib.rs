...
pub mod syscall;
pub mod utils;
//TODO: merge generate_dependencies and generate_trace;
// Re-export the `DTReduceProof` struct from dt_core_machine.
//
// This is done to avoid a circular dependency between dt_core_machine and dt_core_executor, and
// enable crates that depend on dt_core_machine to import the `DTReduceProof` type directly.
pub mod reduce {
    pub use dt_core_executor::DTReduceProof;
}
...
pub mod programs {
    ...
    pub mod tests {
        ...
        pub use test_artifacts::{
            FIBONACCI_ELF, KECCAK_PERMUTE_ELF, PANIC_ELF,
            /* POSEIDON2_PERMUTE_ELF, */ /* SECP256R1_ADD_ELF, SECP256R1_DOUBLE_ELF, */
        ...
        // TODO: uncomment when POSEIDON2_PERMUTE_ELF is available in test_artifacts
        // #[must_use]
