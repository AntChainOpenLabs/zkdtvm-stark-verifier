...
impl<F: Field> ITypeRegisterOp<F> {
...
/// ITypeRegisterOp: 1 Program + 4 op_b read + 4 op_a readwrite = 9
pub(crate) const ITYPE_NUM_INTERACTIONS: usize =
    crate::program::program_polyair::PROGRAM_NUM_INTERACTIONS +
        2 * crate::memory::polyair::MEMORY_READ_NUM_INTERACTIONS;

/// PolyAir gate constraints for ITypeRegisterOp.
pub fn itype_register_op_gate_constraints<AB: dt_stark::air::FullAirBuilder>(
    builder: &mut AB,
...
/// Precompute denominators for ITypeRegisterOp interactions.
///
...
pub fn itype_register_op_precompute_lc<AB: dt_stark::air::FullAirBuilder>(
    builder: &mut AB,
    pc: AB::VarMaybeExt,
    ...
    // #1: send_program (I-Type: op_b=scalar zero-extended, op_c=Word imm, imm_b=0, imm_c=1)
...
/// Declare multiplicities for ITypeRegisterOp's 9 interactions.
pub fn itype_register_op_lookup<AB: dt_stark::air::FullAirBuilder>(
    builder: &mut AB,
    is_real: AB::VarMaybeExt,
) {
    use crate::{
