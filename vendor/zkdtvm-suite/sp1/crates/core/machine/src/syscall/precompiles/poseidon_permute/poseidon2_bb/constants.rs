...
/// Final round constants for the 24-width Poseidon2 external layer on BabyBear.
...
/// Internal round constants for the 24-width Poseidon2 on BabyBear.
pub const RC24_INTERNAL: [u32; 21] = [
