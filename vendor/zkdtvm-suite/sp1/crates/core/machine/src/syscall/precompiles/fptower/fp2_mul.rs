...
use crate::{
    ...
    operations::field::{field_add_op::FieldAddOpCols, field_op::FieldOpCols, range::FieldLtCols},
    utils::{
        limbs_from_prev_access, next_power_of_two, padded_rows_threshold, words_to_bytes_le_vec,
    },
};
...
pub struct Fp2MulAssignCols<T, P: FieldParameters + NumWords> {
    ...
    pub(crate) c0: FieldAddOpCols<T, P>,
    pub(crate) c1: FieldAddOpCols<T, P>,
...
impl<F: Field, P: FpOpField> MachineAir<F> for Fp2MulAssignChip<P> {
