...
pub trait MemoryAirBuilder: BaseAirBuilder {
    ...
    fn eval_memory_access_timestamp(
        ...
        // working in a field larger than `2 * 2^28` (which is true of both BabyBear and KoalaBear).
    ...
    ///
    /// This method verifies that the inputted is less than 2^28 by doing a 16 bit and 12 bit range
    /// check on its limbs.  It will also verify that the limbs are correct.  This method is needed
    ...
    fn eval_range_check_28bits(
        ...
        self.send_byte(
            Self::Expr::from_canonical_u32(ByteOpcode::BitRange as u32),
            limb_12,
            Self::Expr::from_canonical_u32(12),
            Self::Expr::zero(),
            do_check,
        )
    }
