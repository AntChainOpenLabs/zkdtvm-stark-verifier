...
pub fn populate_perm_deg3<F: Field>(
    input: [F; WIDTH],
...
pub fn populate_perm<F: Field, const DEGREE: usize>(
    input: [F; WIDTH],
    expected_output: Option<[F; WIDTH]>,
    input_row: &mut [F],
) {
...
pub fn populate_external_round<F: Field, const DEGREE: usize>(
...
pub fn populate_internal_rounds<F: Field>(
