...
// namespace dt_core_machine_sys::cpu {

// template<class F>
// __DT_HOSTDEV__ void populate_shard_clk(const CpuEventFfi& event, CpuCols<decltype(F::val)>& cols) {
...
// // template<class F>
// // __DT_HOSTDEV__ void populate_memory(CpuCols<decltype(F::val)>& cols, const CpuEventFfi& event) {
...
// // template<class F>
// // __DT_HOSTDEV__ void populate_branch(CpuCols<decltype(F::val)>& cols, const CpuEventFfi& event) {
...
// // template<class F>
// // __DT_HOSTDEV__ void populate_jump(CpuCols<decltype(F::val)>& cols, const CpuEventFfi& event) {
...
// // template<class F>
// // __DT_HOSTDEV__ void populate_auipc(CpuCols<decltype(F::val)>& cols, const CpuEventFfi& event) {
...
// // template<class F>
// // __DT_HOSTDEV__ bool populate_ecall(CpuCols<decltype(F::val)>& cols, const CpuEventFfi& event) {
// //     bool is_halt = false;
...
// template<class F>
// __DT_HOSTDEV__ void event_to_row(const CpuEventFfi& event, CpuCols<decltype(F::val)>& cols) {
