...
class kb31_septic_extension_t {
    ...
    public:
        kb31_t value[7];    
        static constexpr const kb31_t* frobenius_const = kb_constants::frobenius_const;
        static constexpr const kb31_t* double_frobenius_const = kb_constants::double_frobenius_const;
...
class kb31_septic_curve_t {
    public:
        ...
        static constexpr const kb31_t* dummy_x = kb_constants::dummy_x;
        static constexpr const kb31_t* dummy_y = kb_constants::dummy_y;
        static constexpr const kb31_t* start_x = kb_constants::start_x;
        static constexpr const kb31_t* start_y = kb_constants::start_y;
