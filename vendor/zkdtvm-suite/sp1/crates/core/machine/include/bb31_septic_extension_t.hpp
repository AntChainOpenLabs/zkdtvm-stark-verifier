...
class bb31_septic_extension_t {
    ...
    public:
        bb31_t value[7];    
        static constexpr const bb31_t* frobenius_const = bb_constants::frobenius_const;
        static constexpr const bb31_t* double_frobenius_const = bb_constants::double_frobenius_const;
        static constexpr const bb31_t* A_EC_LOGUP = bb_constants::A_EC_LOGUP;
        static constexpr const bb31_t* B_EC_LOGUP = bb_constants::B_EC_LOGUP;
...
class bb31_septic_curve_t {
    public:
        ...
        static constexpr const bb31_t* dummy_x = bb_constants::dummy_x;
        static constexpr const bb31_t* dummy_y = bb_constants::dummy_y;
        static constexpr const bb31_t* start_x = bb_constants::start_x;
        static constexpr const bb31_t* start_y = bb_constants::start_y;
