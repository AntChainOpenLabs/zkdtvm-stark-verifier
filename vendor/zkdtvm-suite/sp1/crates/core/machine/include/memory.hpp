...
// namespace dt_core_machine_sys::memory {
// __DT_HOSTDEV__ __DT_INLINE__ uint32_t unwrap_value(const OptionMemoryRecordEnum& record) {
//     switch (record.tag) {
...
// template<class F>
// __DT_HOSTDEV__ void populate_access(
...
//     const uint16_t diff_12bit_limb = (uint16_t)((diff_minus_one >> 16) & 0xfff);
//     self.diff_12bit_limb = F::from_canonical_u16(diff_12bit_limb).val;
...
//     // output.add_bit_range_check(diff_12bit_limb, 12);
// }
...
// template<class F>
// __DT_HOSTDEV__ void populate_read_write(
