//! An implementation of an exucutor for the zkDTVM RISC-V zkVM.
...
pub mod programs {
    ...
    pub mod tests {
        ...
        pub use test_artifacts::{
            FIBONACCI_ELF, PANIC_ELF,
            /* SECP256R1_ADD_ELF, SECP256R1_DOUBLE_ELF, */ SSZ_WITHDRAWALS_ELF,
            U256XU2048_MUL_ELF,
        };
