...
use dt_prover::{DTVerifyingKey, HashableKey};
...
impl NetworkClient {
    ...
    pub fn get_vk_hash(vk: &DTVerifyingKey) -> Result<B256> {
    ...
    /// * `version`: The version of the zkDTVM circuits to use.
