//! # zkDTVM Prover Client
//!
//! A client for interacting with the prover for the zkDTVM RISC-V zkVM.
...
/// An entrypoint for interacting with the prover for the zkDTVM RISC-V zkVM.
///
...
impl ProverClient {
    ...
    ///
    /// std::env::set_var("DT_PROVER", "network");
