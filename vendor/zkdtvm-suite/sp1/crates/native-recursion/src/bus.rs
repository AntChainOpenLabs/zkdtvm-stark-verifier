use crate::{
    config::{DIGEST_SIZE, D_EF, POSEIDON2_WIDTH},
    interaction::RecursionInteractionBuilder,
};
use native_recursion_derive::AlignedBorrow;
use p3_field::AbstractField;

// TODO_DELETE_AFTER_FULLAIR_BUS_MIGRATION: ordinary AIR bus helpers are kept only for
// copied/reference modules. Native recursion machine chips should use `interaction_full_air_dt`.
#[macro_export]
macro_rules! define_typed_lookup_bus {
    ($Bus:ident, $Msg:ident) => {
        #[derive(Copy, Clone, Debug)]
        pub struct $Bus($crate::interaction::RecursionLookupInteraction);

        impl $Bus {
            #[inline]
            pub fn new(
                interaction_idx: impl Into<$crate::interaction::RecursionInteractionIdx>,
            ) -> Self {
                Self(
                    $crate::interaction::RecursionLookupInteraction::new_global_with_payload_arity(
                        interaction_idx,
                        $Msg::<u8>::width(),
                    ),
                )
            ...
            pub fn lookup_key<AB>(
                ...
                AB: $crate::interaction::RecursionInteractionBuilder,
            {
            ...
            pub fn add_key_with_lookups<AB>(
                ...
                AB: $crate::interaction::RecursionInteractionBuilder,
            {
                self.0.add_key_with_lookups(builder, key.to_vec(), num_lookups);
            }
        }
    };
}
    ...
    ($Bus:ident, $Msg:ident) => {
        ...
        impl $Bus {
            ...
            pub fn new(
                ...
                Self(
                    $crate::interaction::RecursionLookupInteraction::new_per_proof_with_payload_arity(
                        interaction_idx,
                        $Msg::<u8>::width(),
                    ),
                )
            ...
            pub fn lookup_key<AB>(
                ...
                AB: $crate::interaction::RecursionInteractionBuilder,
            {
                self.0.lookup_key_for_proof(builder, Some(proof_idx), key.to_vec(), enabled);
            }
            ...
            pub fn add_key_with_lookups<AB>(
                ...
                AB: $crate::interaction::RecursionInteractionBuilder,
            {
                self.0.add_key_with_lookups_for_proof(
                    builder,
                    Some(proof_idx),
                    key.to_vec(),
                    num_lookups,
...
macro_rules! define_typed_permutation_bus {
    ($Bus:ident, $Msg:ident) => {
        #[derive(Copy, Clone, Debug)]
        pub struct $Bus($crate::interaction::RecursionPermutationInteraction);
        ...
        impl $Bus {
            ...
            pub fn new(
                ...
                Self(
                    $crate::interaction::RecursionPermutationInteraction::new_global_with_payload_arity(
                        interaction_idx,
                        $Msg::<u8>::width(),
                    ),
                )
    ...
    ($Bus:ident, $Msg:ident) => {
        ...
        impl $Bus {
            ...
            pub fn new(
                ...
                Self(
                    $crate::interaction::RecursionPermutationInteraction::new_per_proof_with_payload_arity(
                        interaction_idx,
                        $Msg::<u8>::width(),
                    ),
                )
            ...
            pub fn send<AB>(
                ...
                AB: $crate::interaction::RecursionInteractionBuilder,
            {
                self.0.send_for_proof(builder, Some(proof_idx), message.to_vec(), enabled);
            }
            ...
            pub fn receive<AB>(
                ...
                AB: $crate::interaction::RecursionInteractionBuilder,
            {
                self.0.receive_for_proof(builder, Some(proof_idx), message.to_vec(), enabled);
            }
        }
    };
}
...
impl TranscriptBus {
    pub fn observe<AB: RecursionInteractionBuilder>(
        &self,
        builder: &mut AB,
        proof_idx: impl Into<AB::Expr>,
    ...
    pub fn observe_ext<AB: RecursionInteractionBuilder>(
        &self,
        builder: &mut AB,
        proof_idx: impl Into<AB::Expr> + Clone,
        tidx: impl Into<AB::Expr>,
    ...
    pub fn observe_commit<AB: RecursionInteractionBuilder>(
        &self,
        builder: &mut AB,
        proof_idx: impl Into<AB::Expr> + Clone,
        tidx: impl Into<AB::Expr>,
    ...
    pub fn sample<AB: RecursionInteractionBuilder>(
        &self,
        builder: &mut AB,
        proof_idx: impl Into<AB::Expr>,
        tidx: impl Into<AB::Expr>,
    ...
    pub fn sample_ext<AB: RecursionInteractionBuilder>(
        &self,
        builder: &mut AB,
        proof_idx: impl Into<AB::Expr> + Clone,
        tidx: impl Into<AB::Expr>,
