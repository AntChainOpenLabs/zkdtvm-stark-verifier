...
use crate::{
    ...
    SCAirOpenedValues, StarkGenericConfig,
};
...
pub struct SCShardMainData<SC: SCStarkGenericConfig, M, P> {
    ...
    pub main_data: P,
    /// The PCS stacking height used by this shard's main commitment.
    ///
    /// Permutation traces are committed later, during opening, and must reuse this value so that
    /// Basefold can open preprocessed, main, and permutation batches in one stacked proof.
    pub pcs_stack_log_height: Option<usize>,
