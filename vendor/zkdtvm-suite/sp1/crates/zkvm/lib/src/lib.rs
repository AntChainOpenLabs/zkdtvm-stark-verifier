...
extern "C" {
    ...
    /// Executes an Secp256k1 curve decomposition on the given point.
    ...
    /// Executes an Secp256r1 curve decomposition on the given point.
    ...
    /// Executes the -256 permutation on the given state.
    pub fn syscall_poseidon2_permute(state: *mut [u32; 24]);
    ...
    /// Defers the verification of a valid DT zkVM proof.
