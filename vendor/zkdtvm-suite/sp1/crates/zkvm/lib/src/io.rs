...
/// ### Examples
/// ```ignore
/// let data: Vec<u8> = dt_zkvm::io::read_vec();
/// ```
#[track_caller]
pub fn read_vec() -> Vec<u8> {
    ...
    if ptr.is_null() {
        panic!(
            ...
            Was the correct data written into DTStdin?",
...
/// }
///
/// let data: MyStruct = dt_zkvm::io::read();
/// ```
#[track_caller]
