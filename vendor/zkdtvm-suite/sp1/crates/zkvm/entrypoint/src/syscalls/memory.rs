...
// Memory addresses must be lower than the field prime.
pub const MAX_MEMORY: usize = if cfg!(feature = "koalabear") { 0x7f000000 } else { 0x78000000 };
...
pub unsafe extern "C" fn sys_alloc_aligned(bytes: usize, align: usize) -> *mut u8 {
    ...
    if overflowed || MAX_MEMORY < heap_pos {
        panic!("Memory limit exceeded ({:#010x})", MAX_MEMORY);
    }
